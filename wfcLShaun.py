# wfcLShaun.py - Populates wellfiles for CPEC Lower Shaunavon wells and saves to directory
...
hztl_template_path = abspath("Templates\CPEC LShaun\Lateral Template.hlg")
build_template_path = abspath("Templates\CPEC LShaun\Vertical-Build Template.slg")
tvd_template_path = abspath("Templates\CPEC LShaun\TVD-Gamma Template.slg")
build_window_name = 'STRIP.LOG - Vertical-Build Template.slg'
tvd_window_name = 'STRIP.LOG - TVD-Gamma Template.slg'
wellpath_path = abspath("Templates\CPEC LShaun\Wellpath Template.xlsx")
report_path = abspath("Templates\CPEC LShaun\Report Template.docx")
hazard_path = abspath("Templates\CPEC LShaun\Hazard Template.docx")
...
def ControlVert(login_title, window_name, template_path, log_type):
  ...
  + 'Month xxth, 2017 at xx hrs' + '^{ENTER}KOP {(}xx m MD{)}: Month xxth, 2016 at xx hrs'
